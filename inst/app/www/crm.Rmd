...
CRMsimul <- simulateConsumerResource(n.species = n.species, n_resources = n_resources)
...
E = randomE(n.species = n.species, n_resources = n_resources)
print(E)
...
#simulate the model
CRMsimul <- simulateConsumerResource(n.species = n.species, n_resources = n_resources, resources = resources, stochastic = stochastic, migration_p = migration_p, E=E, t_end = t_end, t_store = t_store)
...
#simulate the model
CRMsimul_batch <- simulateConsumerResource(n.species = n.species, n_resources = n_resources, resources = resources, stochastic = stochastic, migration_p = migration_p, E=E, t_end = t_end, t_store = t_store, inflow_rate = inflow_rate, outflow_rate = outflow_rate)

#fed-batch operation mode

#outflow = 0; inflow>0
inflow_rate = 1
CRMsimul_fedbatch <- simulateConsumerResource(n.species = n.species, n_resources = n_resources, resources = resources, stochastic = stochastic, migration_p = migration_p, E=E, t_end = t_end, t_store = t_store, inflow_rate = inflow_rate, outflow_rate = outflow_rate)
